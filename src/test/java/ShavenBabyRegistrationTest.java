...
import de.embl.cba.morphometry.drosophila.shavenbaby.ShavenBabyRegistration;
import de.embl.cba.morphometry.drosophila.shavenbaby.ShavenBabyRegistrationSettings;
import ij.IJ;
import ij.ImagePlus;
...
//		final String path = ShavenBabyRegistrationTest.class.getResource( "/ShavenBaby01.zip" ).getFile();
		final String path = "/Users/tischer/Documents/justin-crocker-morphometry-registration--data/E3NWT-07-downscaled-svb.tif";
		final ImagePlus imagePlus = IJ.openImage( path );

//		final String path = "/Users/tischer/Documents/justin-crocker-morphometry-registration--data/E3NWT-02.czi";
