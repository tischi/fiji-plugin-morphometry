...
@Plugin(type = Command.class, menuPath = "Plugins>EMBL>FCCF>BD Viewing" )
public class BDImageViewingCommand extends InteractiveCommand
{
	@Parameter
	...
	@Parameter ( label = "Load Table", callback = "loadTable" )
	...
	private String getRandomFilePath()
	{
		...
		return imageTablePath + File.separator + fileNames[ random.nextInt( numFiles ) ];
	}
	...
	{
		return imageTablePath.list( new FilenameFilter()
			{
				@Override
