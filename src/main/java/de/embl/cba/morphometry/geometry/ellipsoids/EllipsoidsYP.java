...
public abstract class EllipsoidsYP
{

	// Adapted from Tobias Pietzsch
	 ...
	 *      </p>
	 */
	public static EllipsoidYP yuryPetrov( final double[][] points )
	{
	...
	public static Ellipsoid yuryPetrov( RandomAccessibleInterval< BitType > mask )
	{

		// TODO: maybe this is not for dense data as it would be very many points...
	 ...
	 */
	private static EllipsoidYP ellipsoidFromEquation( final Matrix V )
	{
		...
		return new EllipsoidYP( cc, null, aa, null, null );
	}
}
